             ...
             implements StringHandler, Validator
{
  ...
  * use value to update decimal value
  ...
  */
  ...
  /** processDigit method
  * @param c  the character to process
  * use numeric value to update decimal value
  */
  ...
  */
  ...
  /** isValid method
  * @return returns true if all characters
  ...
  */
  ...
  /** getNumber method
  * if valid, return calculated decimal value
  * else, return -1
  */
