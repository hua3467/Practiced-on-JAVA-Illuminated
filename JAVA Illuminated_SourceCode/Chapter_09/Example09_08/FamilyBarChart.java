...
public class FamilyBarChart extends JFrame
{
 final int LEFT_MARGIN = 80;        // starting x value
 ...
 public void paint( Graphics g )
 {
  ...
  for ( int i = 0; i < familyCellBills.length; i++ )
  {
   ...
   g.drawString( "Row " + i, xStart - LEFT_MARGIN + 20,
 ...
 {
   FamilyBarChart app = new FamilyBarChart( );
   app.setSize( 275, 375 );
   app.setVisible( true );
 }
}
